...
import 'package:picker/util/image_picker_handler.dart';
                      ...
                      children: <Widget>[
                        ...
                        Center(
                          child: Row(
                            ...
                            children: <Widget>[
                              Text(
                                snapshot.data.documents[0]['rating'].toDouble().toStringAsFixed(2),
                                style: TextStyle(
                        ...
                        dataUnit("Coletas Finalizadas", snapshot.data.documents[0]['finishedRequests'].toString()),
